...
**Note**  
Elastic Beanstalk is not currently available in the Asia Pacific \(Jakarta\) region **ap\-southeast\-3**\. Choose a different AWS region to use the Scorekeep sample application\. 
...
1. Open the Elastic Beanstalk Management Console with this preconfigured link: [https://console\.aws\.amazon\.com/elasticbeanstalk/\#/newApplication?applicationName=scorekeep](https://console.aws.amazon.com/elasticbeanstalk/#/newApplication?applicationName=scorekeep)

1. Under the **Platform** section, set the **Platform** to **Java** and the **Platform branch** to **Corretto 8 running on 64bit Amazon Linux 2**\.
**Note**  
The `xray-gettingstarted` branch of the Scorekeep application doesn't currently support Corretto 11\.

1. Choose **Create application** to create an application with an environment running the Corretto 8 platform\.
...
1. Attach **AWSXrayFullAccess**, **AmazonS3FullAccess**, **AmazonDynamoDBFullAccess**, and **AmazonSNSFullAccess** to the role, if they aren't already present\.
**Note**  
Full access policies aren't best practice for general use\. For instructions on configuring a policy with least permission to reduce security risks, see [Optional: Least privilege policy](#xray-gettingstarted-security)\.
...
1. Download the sample app: [eb\-java\-scorekeep\-xray\-gettingstarted\-v2\.zip](https://github.com/awslabs/eb-java-scorekeep/releases/download/xray-gs-v2/eb-java-scorekeep-xray-gettingstarted-v2.zip)
...
1. Upload eb\-java\-scorekeep\-xray\-gettingstarted\-v2\.zip, and then choose **Deploy**\.
...
![\[X-Ray console service map page\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-servicemap-before-2021.png)
...
![\[Choose the error status icon to open the Exceptions page for the Amazon SNS subsegment\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-timeline-sns-2021.png)
