...
![\[Representation of service graph X-Ray generates from trace data sent by the
              application\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-servicemap-before.png)
...
![\[Choosing the red status icon opens the Exceptions page for the SNS
              subsegment\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-timeline-sns.png)
...
dependencyManagement {
    imports {
        ...
        mavenBom("com.amazonaws:aws-xray-recorder-sdk-bom:1.2.1")
    }
}
```
