...
![\[Nodes for the API, Lambda service, and Lambda function appear as separate but
          connected nodes\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-servicemap-lambda-node.png)
...
![\[Timeline view of a trace, which collects all segments generated by a single
          request\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-timeline-POSTmove.png)
...
![\[Annotations and metadata are viewable in the segment or subsegment details in the
          X-Ray console\]](http://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-PUTrules-customsubsegment-metadata.png)
